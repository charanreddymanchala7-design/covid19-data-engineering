...
### 2. Transformation (ADF Data Flows)
...
### 4. Analytics Layer (Azure SQL Database)
...
- Security Note: All credentials and secrets are excluded from this repository and are expected to be provided via environment variables or secure secret management services.
